...
Channel groups are weighted explicitly in the loss as a stated choice, never
through $\sigma$ as a side effect. Every family --- waist reconstruction,
...
footprint fields at this scale. The tier-P stores added to the cone against
the cone without them, per read-out goal: El Ni\~no through Ni\~no-3.4 at a
