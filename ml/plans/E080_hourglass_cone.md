...
[FIGURE: results_placeholder — the right half of the slide (about 6.2 × 4.6 in) is an empty, dashed-outline panel labelled "RESULTS — figure to be inserted" with a one-line caption underneath naming what belongs there: "R1 · future-cone loss per lead, A0 fixed / A1 learned / A2 primed, 3 seeds; R3 · learned drift vs upstream; R4 · the western-boundary depth check". Nothing is drawn inside the panel; it is a reserved space, not a mock-up. The left half carries four compact cards.]
