# E-073 · Parallel import of the training data — the design (Apache Beam / Flume, polite by construction, lossless by design)
...
The credentials file travels only in the hand-over zip, never in the repo.
