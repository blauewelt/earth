...
|---|---|---|---|
| **#532** E-068 · the TERMINAL-HOLDOUT codec: run-415's architecture with 2021–2024 AND the development blocks 2008–09 / 2016–17 held out (recipe `f4r2-40M-terminal`, 200k×512, d_z 32) | can the frozen protocol's codec (train ≤ 2020) be built without a data tax, so the terminal test and 730-day development rolls share one encoder? | `loss_rec` / probe_head against run-415 (0.22x / 0.579-ish); a collapse or a large reconstruction gap ⇒ the smaller pool broke training. Then Z → 7.6M head → E-067 block rolls of head + LIM to 730 d (development blocks only; 2021–2024 on Chris's word) | gpu-box-49401037 (Vast 49633408, Virginia, tensor cached), dispatched 17:1xZ 09-02; ~19 h + probes ⇒ ~12:30Z 09-03 (24 h token expires 17:1xZ 09-03 — the ladder tail is near the edge); [plan](https://blauewelt.github.io/earth/docs.html?f=ml/plans/E067_block_rolls.md) |
