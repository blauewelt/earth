...
| **#523** E-062-R0c · the 40.4M `head-weights-e060b-20k-window-s0` through #516's identical battery (Chris: "Yes") | does the middle rung of the width ladder forecast like the 7.6M and 206.66M ones on the rolled field? | same shape/level readings as #520; with #516 and #520 the ladder gets three rolled points | gpu-box-49401037 (Vast 49633408, Virginia), dispatched 10:1xZ 09-02; MEASURED 24.3 s/unit over the first 60 of 879 ⇒ ~6 h roll (vs #516's 87.8 s/unit at 206.66M) |
| **#520** E-062-R0b · the 7.6M head `head-weights-e060a-20k-window-s0` through #516's identical battery | does the small-tier clean-pool head forecast as well as the 206.66M one on the rolled field — was capacity ever the axis? | shape: lead-decay must PASS; level: #516's acc 0.606@5d → −0.031@365d, corridor msss_clim −0.439, amp_ratio 0.780, msss_pers +0.204, SST +0.069 to 90 d. Parity or better ⇒ small tier is default for cause | gpu-box-41298070 (Vast 49632479, fresh), started 09:45Z 09-02 (after #518 and #519 died on the old box's full disk); token deadline 09:45Z 09-03; expected well under #516's 21 h 26 m |
