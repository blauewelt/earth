...
| **#523** E-062-R0c · the 40.4M `head-weights-e060b-20k-window-s0` through #516's identical battery (Chris: "Yes") | does the middle rung of the width ladder forecast like the 7.6M and 206.66M ones on the rolled field? | shape and level against BOTH ends now: #516 mean acc 0.105 / msss −0.439 / amp 0.78 and #520 0.103 / −0.179 / 0.54 — the ladder is flat on information at its two ends, so R0c can only confirm or break the null | gpu-box-49401037 (Vast 49633408, Virginia), dispatched 10:1xZ 09-02; MEASURED 24.3 s/unit over the first 60 of 879 ⇒ ~6 h roll (vs #516's 87.8 s/unit at 206.66M) |
