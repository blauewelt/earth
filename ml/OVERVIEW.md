...
| **#530** (was #525) E-065a · continuous d_z-8 pentad codec, 200k×512 — the 24-bit lattice's warm-start parent | can a wider-bottleneck continuous codec be built so a [8]×8 lattice can be warm-started on it the E-050 way? | `loss_rec` / probe_head against run-480 (d_z 6: 0.229 / 0.579) and run-415 (d_z 32) — a parent worse than run-480 has a training fault and its lattice is not built | **#525 CANCELLED 15:02Z on a mis-read pace (see the log) → RE-DISPATCHED as #530** on gpu-box-48647862 (Vast 49632487, Germany, restarted with the tensor cached), picked up 15:03Z, through data cache in 1 min 40 s; ~14 h + probes ⇒ ~05:30Z 09-03; [plan](https://blauewelt.github.io/earth/docs.html?f=ml/plans/E065_fsq_ladder.md) |
