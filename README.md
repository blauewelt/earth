...
| [ml/paper/notes/family1tf.pdf](ml/paper/notes/family1tf.pdf) | Dataset design note for family 1.tf, the proposed TERRESTRIAL + COASTAL fine-granularity family: hourly and daily station networks (GHCNh, GHCN-Daily, IGRA), tide gauges (GESLA), coastal buoys, high-frequency radar currents, gliders, flux towers, fire detections, river gauges; daily 0.05° land fields (MODIS/VIIRS temperature, reflectance, snow; IMS 1 km snow; CHIRPS pentads); the scene catalogue for the petabyte-scale tile tier (Sentinel-1/2, HLS, Landsat, NISAR, OLCI, VIIRS, OPERA); the coastal-band definition; the licence gate that excludes ISMN, GRDC, ECA&D, HadISD and MSWEP; sizes, phases, falsifiers and open decisions |
