...
- **Pixel inspector** — click anywhere on the globe for one card that composes everything the app can know about that point: live weather and a 7-day forecast (Open-Meteo), all nine satellite fields probed at the chosen date, climate normals with the SST anomaly against 1991–2020, and nearby context (monitoring sites, Argo floats, major emitters, glaciers). It is [docs/PIXEL_STATE.md](docs/PIXEL_STATE.md) made clickable.
